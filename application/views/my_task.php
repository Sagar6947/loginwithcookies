                ...
                <div class="col-12 col-lg-12 mt-3 ">
                    ...
                    <div class="card border  h-100 notes-list-section">
                        ...
                        <div class="row notes">
                            ...
                            if (!empty($task)) {
                                foreach ($task as $assign) {

                                    if (isset($status)) {
                                        $task_list = $this->CommonModal->getRowByIdInOrder('tbl_task',  array('status' => $status, 'tid' => $assign['task_id']), 'tid', 'DESC');
                                    } else {
                                        $task_list = $this->CommonModal->getRowByIdInOrder('tbl_task',  array('tid' => $assign['task_id']), 'tid', 'DESC');
                                    }
                                    if (!empty($task_list)) {
                            ...
                            ?>
                                            ...
                                            <div class="col-12  col-md-6 col-lg-4 my-3 note business-note all starred" data-type="business-note" id="mytable">
                                                <div class="card">
                                                        ...
                                                        <div class="card-body p-4">
                                                            ...
                                                            <p class="small-content text-muted mb-10">
                                                                ...
                                                                <?php if ($task['image'] !=  '') { ?>
                                                                    ...
                                                                    <a href="<?= base_url() ?>uploads/img/<?= $task['image'] ?>" class="btn btn-info">View Screen shot</a>
                                                            ...
                                                            <div class="d-flex notes-tool">
                                                                ...
                                                                <h6 class="f11"><span class="dot  <?= (($task['status'] == '0') ? '' : 'bg-red') ?>"> </span> <?= (($task['status'] == '0') ? 'Normal Work' : 'High Priority work') ?></h6>
                                                                <div class="ml-auto">
